...
Table~\ref{tab:external-comparison} compares the framework-shaped external baseline with the full evidence chain. The external baseline improves replayability relative to the local baseline, reaching an average score of 4.0, because the adapter preserves a somewhat richer default execution surface. However, it leaves explicit intent capture, policy persistence, integrity verification, and receipt export absent. As a result, explicitness, tamper sensitivity, audit boundedness, and evidence-stage exposure remain at 1.0, 0.0, 2.0, and 1.0 respectively.
