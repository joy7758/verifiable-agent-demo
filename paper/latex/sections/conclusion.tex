...
The checked-in evaluation harness supports a bounded version of that claim with a deterministic 16-task suite, a stable five-file export contract, a third-party review script, a minimal live CrewAI baseline, four ablation modes, and a blinded human-review kit. Across the current summaries, the full evidence chain preserves review questions that the trace-oriented baseline and the live framework observability baseline do not explicitly retain, and it shows interpretable degradation under targeted ablations.
